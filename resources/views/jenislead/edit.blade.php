...
<div class="container mt-3">
    <div class="card card-primary card-outline " style="border-color: #00518d;">
        <div class="card-header">
            <h3 class="card-title"><i class="fas fa-edit mr-1" style="color: #00518d;"></i>Edit Jenis Lead</h3>
        </div>
        <div class="card-body">
            <form action="{{ route('jenislead.update', $jenislead->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="form-group">
                    ...
                    <input type="text"
                           ...
                           id="jenis"
                           name="jenis"
                           value="{{ old('jenis', $jenislead->jenis) }}"
                           required>
                    @error('jenis')
